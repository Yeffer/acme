...
<div class="card">
  	<div class="card-header">EDITAR PROPIETARIO</div>
 		<div class="card-body">
			<form class="form-horizontal" id="clienteForm" method="POST" action="{{ route('propietarios.update', $propietarios->id) }}">
				@csrf @method('PATCH')
			  ...
			  <div class="form-group row">
			    	...
			    	<div class="col-sm-10">          
				        <input type="text" 
				        	   ...
				        	   class="form-control" 
				        	   value="{{$propietarios->primer_nombre}}" 
				        >
				...
				<div class="form-group row">
			    	...
			    	<div class="col-sm-10">          
				        <input type="text" 
				        	   ...
				        	   class="form-control" 
				        	   value="{{$propietarios->segundo_nombre}}" 
				        >
